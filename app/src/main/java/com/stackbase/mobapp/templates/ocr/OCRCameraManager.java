 ...
 */
public final class OCRCameraManager {

    private static final String TAG = OCRCameraManager.class.getSimpleName();
     ...
     */
    private final OCRPreviewCallback previewCallback;
    ...
    public OCRCameraManager(Context context, InfoTemplate ocrTpl) {
        this.context = context;
        this.configManager = new OCRCameraConfigurationManager(context);
        previewCallback = new OCRPreviewCallback(configManager);
        this.ocrTpl = ocrTpl;
    }
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int width = this.ocrTpl.getWidth();
            ...
            int height = this.ocrTpl.getHeight();
